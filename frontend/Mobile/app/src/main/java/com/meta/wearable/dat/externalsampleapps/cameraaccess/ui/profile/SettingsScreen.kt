...
fun SettingsScreen(
    ...
    Column(
        ...
        SettingSection("How fast VISOR talks", palette)
        ...
        SettingSection("How much detail", palette)
        Row(horizontalArrangement = Arrangement.spacedBy(10.dp)) {
        ...
        SettingSection("Display", palette)
        ChoiceChip(
        ...
        SettingSection("Account", palette)
        ChoiceChip("Log out", selected = false, palette = palette, modifier = Modifier.fillMaxWidth(), onClick = onLogout)
        ChoiceChip("Delete my account", selected = false, palette = palette, modifier = Modifier.fillMaxWidth(), onClick = onDeleteAccount)
    }
}

@Composable
private fun SettingSection(title: String, palette: VisorPalette) {
    Text(
        title,
...
private fun ChoiceChip(
    ...
    OutlinedButton(
        ...
        colors = ButtonDefaults.outlinedButtonColors(
            ...
            contentColor = if (selected) palette.onAccent else palette.textPrimary,
        ),
    ) {
        Text(
            label,
...
private fun SettingsPreview() {
    ...
    SettingsScreen(profile = profile, onProfileChange = { profile = it }, palette = VisorPalette.Clarity)
}
